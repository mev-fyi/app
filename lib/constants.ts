export const questions = [
    ...
    "Give me the full composition of an Ethereum block. How it relates to the consensus, data availability, settlement, and execution layer?",
    ...
    "How to spin off an Ethereum node? Give me a step by step bullet point list",
