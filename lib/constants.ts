export const questions = [
    ...
    "Describe an Order Flow Auction (OFA)",
    ...
    // "Explain the differences between Uniswap v2, v3 and v4",
    "What is a commit-reveal scheme?",
    "What is the impact of latency in MEV extraction?",
    ...
    "What is a Searcher?",
    "What is a Proposer?",
    "How does a MEV-Boost Relay work?",
    // "What is an attester?",
    ...
    "What is finality and how does it relate to MEV?",
    // "What is Tendermint?",
    ...
    "Why is Sybil resistance important in consensus protocols?",
