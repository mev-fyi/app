...
// Load font files using fs and path
const interRegular = readFileSync(join(process.cwd(), 'assets/fonts/Inter-Regular.woff')).buffer;
const interBold = readFileSync(join(process.cwd(), 'assets/fonts/Inter-Bold.woff')).buffer;
