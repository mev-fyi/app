...
function IconGoogle({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M21.35 11.1h-8.9v2.7h5.25c-.45 2.35-2.62 4.05-5.25 4.05-3.15 0-5.7-2.55-5.7-5.7s2.55-5.7 5.7-5.7c1.5 0 2.85.6 3.8 1.55l2-2c-1.7-1.6-3.9-2.6-6.5-2.6-5.3 0-9.6 4.3-9.6 9.6s4.3 9.6 9.6 9.6c5.1 0 9.15-3.45 9.55-8.1z"/>
    </svg>
  )
}
...
function IconNewChat({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
...
function IconYouTube({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg 
      ...
      {...props}
    >
      <path fill="red" d="M21.8 8s-.2-1.6-1-2.3c-.9-.9-1.9-.9-2.3-1C15.6 4.4 12 4.4 12 4.4s-3.6 0-6.5.3c-.5.1-1.4.1-2.3 1-.8.7-1 2.3-1 2.3S2 9.6 2 11v2c0 1.4.2 3 .2 3s.2 1.6 1 2.3c.9.9 2.1.8 2.6.9 1.9.1 8.2.2 8.2.2s3.6 0 6.5-.3c.5-.1 1.4-.1 2.3-1 .8-.7 1-2.3 1-2.3s.2-1.6.2-3v-2c0-1.4-.2-3-.2-3zm-12.8 7V9l6 3.5-6 3.5z"/>
    </svg>
  )
}
