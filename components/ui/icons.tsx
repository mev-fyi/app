...
function IconReloadQuestions({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      width="24" // Updated size
      height="24" // Updated size
      viewBox="0 0 24 24" // Updated viewBox to match the size
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      {...props}
    >
      {/* The path data remains the same, it will scale to fit the new viewBox */}
